...
Rchat.internal.comp = function(m) {
    return "<div id=\"chat_sis\" class=\"chat"+$('#chat_bl').last().attr('class').match(/\d+/)[0]+"\"\"><div id=\"chat_bl\"><div id=\"chat_group\"><div id=\"chat_avatar\"><img src=\"" + _userdata.avatar.match(/"(.+?)(?=")/)[1] + "\"/></div><div id=\"chat_name\">" + _userdata.username + "</div></div><div id=\"chat_message\">" + m + "</div></div></div>";
};
